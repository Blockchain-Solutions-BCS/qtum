...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // bcs
        hashUTXORoot.SetNull(); // bcs
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //bcs
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //bcs
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //bcs
    {
