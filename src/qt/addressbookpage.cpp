    ...
    tab(_tab)
{
    ...
    if (!platformStyle->getImagesOnButtons()) {
        ...
        ui->newAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/add", PlatformStyle::PushButton));
        ui->copyAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/editcopy", PlatformStyle::PushButton));
        ui->deleteAddress->setIcon(platformStyle->MultiStatesIcon(":/icons/remove", PlatformStyle::PushButton));
    ...
    {
    case SendingTab:
        ui->labelExplanation->setText(tr("These are your BCS addresses for sending payments. Always check the amount and the receiving address before sending coins."));
        ui->deleteAddress->setVisible(true);
        ui->newAddress->setVisible(true);
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your BCS addresses for receiving payments. It is recommended to use a new receiving address for each transaction."));
