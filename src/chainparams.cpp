...
{
    const char* pszTimestamp = "Feb 13, 2020 Bitcoin Price Suddenly Drops $300 in 1 Hour After $10,500 Rejection ";
...
public:
    CMainParams() {
        ...
        consensus.BIP16Exception = uint256S("0x07b01c0af3321982bcb6b691412769084f918b71027f2c06090655795a8bb9d3");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x07b01c0af3321982bcb6b691412769084f918b71027f2c06090655795a8bb9d3");
        ...
        consensus.defaultAssumeValid = uint256S("0x07b01c0af3321982bcb6b691412769084f918b71027f2c06090655795a8bb9d3"); 
        ...
        genesis = CreateGenesisBlock(1581580800, 9452, 0x2007ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x07b01c0af3321982bcb6b691412769084f918b71027f2c06090655795a8bb9d3"));
        assert(genesis.hashMerkleRoot == uint256S("0x3b08679d4a544b0526f8f91ffbb39fe8ad5e419c543e69a962dad1ceb87814be"));
        ...
        checkpointData = {
			{
                {0, uint256S("07b01c0af3321982bcb6b691412769084f918b71027f2c06090655795a8bb9d3")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1581580801, 9589, 0x2007ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x07942c1738c28cfaf2cfc68f64ccec566923f36bd77b5616de163f656b7bfce7"));
        assert(genesis.hashMerkleRoot == uint256S("0x3b08679d4a544b0526f8f91ffbb39fe8ad5e419c543e69a962dad1ceb87814be"));
        ...
        checkpointData = {
			{
                {0, uint256S("07942c1738c28cfaf2cfc68f64ccec566923f36bd77b5616de163f656b7bfce7")},
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1581580801, 196, 0x2007ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x07bff4e7d5211403f77fe2413e2d7263bed24ee7d870b38f711992ce41eacfed"));
        assert(genesis.hashMerkleRoot == uint256S("0x3b08679d4a544b0526f8f91ffbb39fe8ad5e419c543e69a962dad1ceb87814be"));
        ...
        checkpointData = {
            {
                {0, uint256S("07bff4e7d5211403f77fe2413e2d7263bed24ee7d870b38f711992ce41eacfed")},
            }
        };
