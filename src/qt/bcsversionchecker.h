#ifndef BCSVERSIONCHECKER_H
#define BCSVERSIONCHECKER_H

#include <QObject>

#define BCS_RELEASES "https://github.com/Blockchain-Solutions-BCS/bcschain-core/releases"
...
class BCSVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit BCSVersionChecker(QObject *parent = 0);
    ~BCSVersionChecker();
